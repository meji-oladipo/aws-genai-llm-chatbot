...
export default function PromptLibrary() {
  ...
  const loadPrompts = async () => {
    ...
    try {
      ...
      console.log("Prompts result:", promptsResult);
      const promptsData = promptsResult.data?.listBedrockPrompts || [];
      
      // Map the data to match our interface
      const mappedPrompts = promptsData.map((prompt: any) => ({
        id: prompt.promptId,
        name: prompt.name,
        description: prompt.description,
        defaultVariant: prompt.variants ? JSON.parse(prompt.variants) : undefined
      }));
  ...
  const handleCreatePrompt = async () => {
    try {
      ...
      //   authMode: "AMAZON_COGNITO_USER_POOLS",
      // });
      console.log("Create prompt not implemented yet");
  ...
  const handleUpdatePrompt = async () => {
    try {
      ...
      //   authMode: "AMAZON_COGNITO_USER_POOLS",
      // });
      console.log("Update prompt not implemented yet");
  ...
  const handleDeletePrompt = async () => {
    try {
      ...
      //   authMode: "AMAZON_COGNITO_USER_POOLS",
      // });
      console.log("Delete prompt not implemented yet");
